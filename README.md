...
<img width="2377" height="1471" alt="eda_riesgo_clientes" src="https://github.com/user-attachments/assets/04328bea-ea37-4163-be1d-f5d76abb68e8" />
...
| Real Alto | 40 (FN)  | 266 (TP) |

Los **40 falsos negativos** son el caso más crítico: clientes de alto riesgo clasificados incorrectamente como bajo riesgo.

<img width="2080" height="1837" alt="evaluacion_modelo" src="https://github.com/user-attachments/assets/3c61ff2c-a479-482e-a655-71667c5e2f31" />
...
```bash
git clone https://github.com/Jonathanmerel/credit-risk-ml.git
cd credit-risk-ml
